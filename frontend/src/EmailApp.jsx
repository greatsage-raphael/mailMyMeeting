  ...
  const composeEmail = () => {
    if (draftEmail) {
      ...
      const newDraft = {
        ...
        to: '',
        subject: '',
        body: transcription, // Initialize body with transcription
      ...
      <div className="email-app">
        {isLoading ? (
          ...
          <>
            ...
            {draftEmail?.isOpen ? (
              <SendEmails
                key={draftEmail.last_message_timestamp}
                userId={userId}
                draftEmail={draftEmail}
...
EmailApp.propTypes = {
  ...
  transcription: PropTypes.string, // Added transcription prop type
};
